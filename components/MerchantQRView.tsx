          ...
          <div className="flex items-center p-4 rounded-xl bg-white/30 dark:bg-white/5 border border-slate-200 shadow-md dark:border-white/10">
            {showInputs ? (
                ...
                <div className="space-y-4 px-4">
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      ...
                      const intPartRaw = parts[0].replace(/[^0-9]/g, '') || '0';
                      const decPartRaw = parts.slice(1).join('').replace(/[^0-9]/g, '');
                    ...
                    className="w-2/3 bg-slate-200 dark:bg-slate-900/50 border-b border-slate-400 dark:border-slate-600 rounded-xl px-4 py-2.5 text-md text-slate-900 dark:text-white focus:outline-none focus:border-b-2 focus:border-b2u-blue transition-all"
                    placeholder="e.g. 100,000"
                  />
                </div>

                <div className="space-y-4 px-4">
                  <label className="text-md font-bold text-slate-600 dark:text-slate-400 ml-1 uppercase">Digital Transactions %</label>
              ...
              <div className="md:px-4 space-y-8 w-full">
                ...
                <div>
                  <p className="text-lg text-slate-500 mb-2">Estimated Digital Transactions Amount</p>
                  <div className="p-4 rounded-xl bg-gradient-to-r from-b2u-blue/5 to-b2u-cyan/5 border border-b2u-blue/20 flex items-center justify-center">
                    <p className="text-2xl font-bold text-slate-800 dark:text-white">{digitalTransactionsAmountFormatted}</p>
                  </div>
                </div>

                <div className="mt-3 grid grid-cols-2 gap-3">
                  <div>
                    <p className="text-md text-slate-500 mb-2">Card Commission (2.5%)</p>
                    <div className="p-3 rounded-xl bg-gradient-to-r from-b2u-blue/5 to-b2u-cyan/5 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 flex items-center justify-center min-w-0">
                      <p className="text-xl font-semibold whitespace-nowrap">{cardCommissionFormatted}</p>
                    </div>
                  </div>
                  <div>
                    <p className="text-md text-slate-500 mb-2">QR Commission (1.0%)</p>
                    <div className="p-3 rounded-xl bg-gradient-to-r from-b2u-blue/5 to-b2u-cyan/5 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700 flex items-center justify-center min-w-0">
                      <p className="text-xl font-semibold whitespace-nowrap">{qrCommissionFormatted}</p>
                    </div>
                  </div>
                </div>

                <div className="mt-3">
                  <p className="text-xl text-slate-500 mb-2">Profit</p>
                  <div className="p-5 rounded-xl bg-gradient-to-r from-b2u-blue/15 to-b2u-cyan/15 dark:bg-slate-800/40 border border-slate-200 dark:border-slate-700 flex items-center justify-center">
                    <p className="text-4xl font-bold text-green-600 dark:text-green-400">{profitFormatted}</p>
                  </div>
                </div>
